			...
			<div class="container">
                <div class="row">
                    ...
                    <div class="btn-inverse">
                    	<a class="hvr-underline-from-center animated tada btn btn-lg btn-default smoothScroll" href="#blog">Go To Get Knowledge</a>
                    </div>
                	</div>
            </div>
			</div>
		</div>
<section id="about" class="section--white" style="margin-top: 40px;">
